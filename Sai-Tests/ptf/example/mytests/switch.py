...
from switch_sai.switch_sai.ttypes import  *
...
def sai_thrift_add_ports_to_vlan(vlan_id, port_list):
    return 0
...
class L2AccessToAccessVlanTest(sai_base_test.SAIThriftDataplaneTest):
    def runTest(self):
        ...
        sai_thrift_add_ports_to_vlan(vlan_id, [vlan_port1, vlan_port2])
        ...
        try:
            ...
            # self.client.sai_thrift_remove_ports_from_vlan(vlan_id, [vlan_port1, vlan_port2]) TODO: add
